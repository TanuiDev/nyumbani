  ...
  return (
    <div className="p-4">
        ...
        <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0 whitespace-nowrap cursor-pointer">
                <h3>View All</h3>
                <FaArrowRightLong />
            </div>
        </div>
            ...
            {featuredHouses.map((house) => (
                <div className="bg-white rounded-2xl shadow-md overflow-hidden w-full sm:w-[300px] md:w-[400px]" key={house.id}>
                    <div className="relative">
                        ...
                        {/* Top-right: featured tag (only shown when true, sits left of the icon column) */}
                        {house.featured && (
                            <span className="absolute top-3 right-14 bg-orange-500 text-white text-sm font-medium px-3 py-1 rounded-full shadow">
                                Featured
                            </span>
                        )}

                        {/* Top-right: action icons, fixed column so nothing else can collide with it */}
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-center gap-6 text-gray-600 text-sm mt-3">
                            <span className="flex items-center gap-1">
                                <FaBed /> {house.bedrooms === 0 ? "Studio" : house.bedrooms}
                            </span>
                            <span className="flex items-center gap-1">
